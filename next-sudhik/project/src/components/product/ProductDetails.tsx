...
// // export default function ProductDetails({ product, rating, reviewCount }: ProductDetailsProps) {
// //   return (
// //     <section id="product" className="relative py-16 sm:py-24 lg:py-32 bg-ivory">
// //       <div className="absolute inset-0 bg-lotus-fade opacity-60 pointer-events-none" />
...
// //           viewport={{ once: true }}
// //           transition={{ duration: 0.6, delay: 0.1 }}
// //           className="font-deva text-center text-maroon-600 text-base sm:text-lg mt-4 px-2"
// //         >
// //           हर बूँद में गंगाजल — शुद्धता की पवित्र गारंटी।
// //         </motion.p>
...
// //         <Divider className="mt-20 sm:mt-28" />
// //       </div>
// //     </section>
// //   );
// // }
